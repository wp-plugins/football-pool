...
(window.tinyMCE.execCommand("mceInsertContent",0,e),tinyMCEPopup.editor.execCommand("mceRepaint"),tinyMCEPopup.close())},calculate:k,bulk_action_warning:function(d){var e=b("#"+d);return e&&0!=e.prop("selectedIndex")?(d=b("#"+d+" option").filter(":selected").attr("bulk-msg"),""!=d&&void 0!=d?confirm(d):!0):!1},toggle_points:function(d){b("#"+d+"_points").toggle()},set_input_param:function(d,e,f){var g;b.isArray(e)&&1<=e.length?b.each(e,function(c,a){""!=a&&(b.isArray(h[a])||(h[a]=[]),h[a][d]=b(a).attr(d),
g=b.isArray(f)?f[c]:f,b(a).attr(d,g))}):""!=e&&(h[e]=[d,b(e).attr(d)],g=b.isArray(f)?f[0]:f,b(e).attr(d,g))},restore_input_param:function(d,e){var f="";b.isArray(e)&&1<=e.length?b.each(e,function(e,c){f=void 0!=typeof h[c][d]?h[c][d]:"";b(c).attr(d,f)}):""!=e&&(f=void 0!=typeof h[e][d]?h[e][d]:"",b(e).attr(d,f))},disable_inputs:function(d,e){var f=e||"",g=!1;""!=f&&(g=b("#"+f).is(":checked"));b.isArray(d)&&1<=d.length?b.each(d,function(c,a){""!=a&&(""!=f?g?b(a).attr("disabled","disabled"):b(a).removeAttr("disabled"):
b(a).attr("disabled","disabled"))}):""!=d&&(""!=f?g?b(d).attr("disabled","disabled"):b(d).removeAttr("disabled"):b(d).attr("disabled","disabled"))},toggle_linked_options:function(d,e){b.isArray(d)&&1<=d.length?b.each(d,function(d,e){""!=e&&b(e).toggle(!0)}):""!=d&&b(d).toggle(!0);b.isArray(e)&&1<=e.length?b.each(e,function(d,e){""!=e&&b(e).toggle(!1)}):""!=e&&b(e).toggle(!1)}}}(jQuery);jQuery(document).ready(function(){jQuery("input[title].with-hint").inputHints()});
