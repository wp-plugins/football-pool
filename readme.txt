...
* Added possibility to hide match types from the website. Usefull for competitions with large amounts of matches where you don't want to show every match all the time. Invisible match types are not shown on the website (matches page and prediction page, but are still calculated for the scores.
