...
class Football_Pool_Admin_Options extends Football_Pool_Admin {
	...
	public function admin() {
		$options = array(
						...
						array( 'text', __( 'Standaard pool voor nieuwe gebruikers', FOOTBALLPOOL_TEXT_DOMAIN ), 'default_league_new_user', __( 'De standaardpool (<a href="?page=footballpool-leagues">ID van de pool</a>) waar nieuwe spelers in worden geplaatst nadat ze zich hebben geregistreerd.', FOOTBALLPOOL_TEXT_DOMAIN ) ),
